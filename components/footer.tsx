      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mb-6">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                <Input
                  ...
                  required
                />
                <Button type="submit" className="bg-[#e51083] hover:bg-[#c50e73]">
                  {t("subscribe")}
                </Button>
              </form>
            </div>
            ...
            <div className="flex space-x-4">
              <Button variant="ghost" size="sm" className="text-gray-400 hover:text-[#e51083] p-2">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">support@bidiigirlsprogram.org</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Bidii Girls Program. {t("allRightsReserved")}
          </p>
        </div>
      </div>
    </footer>
